...
|[\[a\]](#cmnt_ref1)<p> ITEM 2.3.3|</p> Devem ser implementados mecanismos de criptografia para proteger a base de dados, o cofre de senhas e todas as informações armazenadas e tratadas pelos componentes da solução;</p>|
|[\[b\]](#cmnt_ref2)<p> 2.3.5|</p> A criptografia implementada pela solução deve se basear em algoritmos e parâmetros fortes, incluindo no mínimo os padrões RSA-2048, AES-256 e SHA-256, e deve ser compatível com o padrão FIPS 140-2.</p>|
